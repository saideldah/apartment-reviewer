...
This file gives the AI Agent a short set of market facts and a curated list of reliable sources for apartment analysis in Germany, with extra focus on Berlin.

The AI Agent should use this file to:
...
When the AI Agent needs market context, it should prefer sources in this order:
...
# 2. Germany-wide facts the AI Agent can use
...
This helps the AI Agent describe the broad national cycle:
...
The AI Agent should treat financing cost as a core market input, especially for buyer-side apartment analysis.
...
The AI Agent can use vdp as a secondary benchmark because it is based on actual transaction and financing data from lending institutions.
...
For rent-increase discussions, the AI Agent should know that the legal benchmark concept is anchored in German law.
...
This helps the AI Agent distinguish:
...
# 3. Berlin-specific facts the AI Agent can use
...
This is the correct source when the AI Agent needs to talk about:
...
The AI Agent must not mix these up.
...
This gives the AI Agent a strong benchmark for:
...
This gives the AI Agent good macro context when discussing:
...
For transaction-based Berlin market evidence, the AI Agent should prefer the Gutachterausschuss market reports.
...
For land-value context, the AI Agent should know:
...
# 4. Recommended source list for the AI Agent
...
# 5. Practical rules for the AI Agent
...
The AI Agent should not overload every report with market statistics.
...
The AI Agent may use phrasing like:
...
When possible, the AI Agent should prefer:
